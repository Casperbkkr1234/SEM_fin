...
def longstaff_schwartz(paths, strike, r,option_type):
    ...
    for t in range(1,T):
        ...
        Xs = np.column_stack([ones_column,X,X2])
...
r = 0.06
mu = 0  # Drift (average return per unit time)
...
num_paths = 8  # Number of simulation paths

# Simulate stock price paths
paths = simulate_gbm(r, sigma, S0, T, dt, num_paths)
paths[0,:]=S0
paths = paths[::-1]

print(longstaff_schwartz(paths = paths, strike =1.1, r = r, option_type="Put"))